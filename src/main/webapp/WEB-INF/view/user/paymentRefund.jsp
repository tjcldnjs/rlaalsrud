...
<body>
    <div class="container">
        <h1>환불 요청</h1>
        <form action="/user/paymentRefund" method="post">
                <input type="hidden" name= id value="${payment.id}">
            <div class="form-group">
                <label for="orderNumber">주문번호</label>
                <input type="text" id="orderNumber" name="orderNumber" value = "${payment.orderId}"disabled="disabled">
            </div>
            <div class="form-group">
                <label for="paymentMethod">결제수단</label>
                <input type="text" id="paymentMethod" name="paymentMethod" value = "${payment.method}"disabled="disabled">
            </div>
            <div class="form-group">
                <label for="totalAmount">총금액</label>
                <input type="text" id="totalAmount" name="totalAmount" value = "${payment.totalAmount}"disabled="disabled">
            </div>
            <div class="form-group">
